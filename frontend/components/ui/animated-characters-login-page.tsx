...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-rose-500 via-fuchsia-500 to-fuchsia-600 p-12 text-primary-foreground">
